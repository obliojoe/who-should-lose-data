...
def build_team_analysis_prompt_v2(
    team_abbr,
    team_stats_row,
    opponent_abbr,
    opponent_stats_row,
    ...
    """
    Build AI analysis prompt using redesigned 4-section structure.

    New sections:
    1. ai_verdict - Combined engaging summary + bold take (replaces summary + hottake)
    2. ai_xfactor - Key matchup insights and what will decide the game (replaces preview)
    3. ai_reality_check - Statistical truth with humor (replaces stats + roast)
    4. ai_quote - One shareable quote that captures the team's season (new)
...
4. ai_quotes
   - FIVE distinct quotes that capture this team's season from different angles
   - Short, punchy, witty observations - NOT statistical breakdowns
   ...
   - Examples of the VIBE we want:
     * "They're not rebuilding, they're just bad at building."
     * "Playing like a team that googles 'prevent defense' during timeouts."
     * "Their playoff hopes and my New Year's resolutions have the same survival rate."
